...
var userErrors_1 = require("../models/errors/userErrors");
var UserRepository = /** @class */ (function () {
    function UserRepository(_prisma) {
        this.prisma = _prisma;
    }
    UserRepository.prototype.get = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.prisma.user.findFirst({ where: { id: id } })];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        e_1 = _a.sent();
                        if (e_1 instanceof client_1.Prisma.PrismaClientUnknownRequestError) {
                        ...
                        if (e_1 instanceof client_1.Prisma.PrismaClientKnownRequestError) {
                            if (e_1.code === "P2002") {
                                ...
                                throw new userErrors_1.UserAlreadyExistError();
                            }
                        }
                        console.log(e_1);
    ...
    UserRepository.prototype.update = function (newUsr) {
        return __awaiter(this, void 0, void 0, function () {
            var e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.prisma.user.update({ data: newUsr, where: { id: newUsr.id } })];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    UserRepository.prototype.getByLogin = function (login) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.prisma.user.findFirst({ where: { login: login } })];
            });
        });
    };
    UserRepository.prototype.getWithFilter = function (filters) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.prisma.user.findMany({
